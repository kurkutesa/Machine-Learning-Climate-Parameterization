...
* [work/NN/colab/](./work/NN/colab/) contains those machine learning-related codes in .ipynb format, but it will not be the most up-to-date version. It is yet to be synchronized with Colab.
